...
# for batch input
input_image1 = load_image("img/chair.jpeg") #load_image("https://cvlab-zero123-live.hf.space/file=/home/user/app/configs/4_blackarm.png")
